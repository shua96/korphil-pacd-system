                        ...
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col cols="12" sm="6" md="4">
                                        <v-text-field v-model="editedItem.emailadd" label="Email Add"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="4">
                                        <v-text-field v-model="editedItem.house" label="Address"></v-text-field>
                                    </v-col>
                                </v-row>
                            </v-container>
                        </v-card-text>
...
export default {
    data: () => ({
        ...
        headers: [
            ...
            { title: 'Email Add', key: 'emailadd' },
            { title: 'Address', key: 'house' },
